...
<?php 
		...
		<div style="display: none;" class="wpProQuiz_results">
			<h4 class="wpProQuiz_header"><?php _e('Results', 'wp-pro-quiz'); ?></h4>
						...
						<tbody>
							<tr>
								...
								<td class="wpProQuiz_resultValue">
									<div style="background-color: #f3715d;">&nbsp;</div>
									<span>&nbsp;</span>
								</td>
							</tr>
							<tr>
								...
								<td class="wpProQuiz_resultValue">
									<div style="background-color: #3d4e5b;">&nbsp;</div>
									<span>&nbsp;</span>
								</td>
							</tr>
						</tbody>
				...
				<div style="margin: 10px 0px;">
					<div class='quiz_continue_link'  style="margin: 10px 0px;">
						...
						<div class="wpProQuiz_matrixSortString">
							...
							<?php
								...
								foreach($answerArray as $k => $v) {
							 	...
							 	foreach($answerArray as $k => $v) {
							 ?>
							 <li class="wpProQuiz_sortStringItem" data-pos="<?php echo $k; ?>" data-correct="<?php echo implode(',', $matrix[$k]); ?>">
	...
	// 									$catPoints[$question->getCategoryId()] += $question->getPoints();
			...
			<?php if($this->quiz->getQuizModus() == WpProQuiz_Model_Quiz::QUIZ_MODUS_SINGLE) { ?>
				<div>
					<input type="button" name="wpProQuiz_pageLeft" data-text="<?php echo esc_attr(__('Page %d', 'wp-pro-quiz')); ?>" style="float: left; display: none;" class="wpProQuiz_button wpProQuiz_QuestionButton">
